...
from utils.utils_plot import plot_segment, plot_pie
...
class SensorDataset(Dataset):
    ...
    This class slightly modified from the original implementation at:
    ...
    def get_info(self, n_samples=3):
        print(f"[-] Information on {self.prefix} dataset:")
        ...
        for i, random_idx in enumerate(target_idx_samples):
            ...
            if i == 0:
                print(f"[-] Information on segment #{random_idx}/{self.len}:")
